...
- f7ad3a892: Fix Azure URL handling to properly support both repo shorthand (`/owner/_git/project`) and full URLs (`/owner/project/_git/repo`).
...
- cc5c8f497: Handle pagination on return results when fetch GitHub API to list selected repos
